...
const RepresentativePersonCard = ({imgUrl, personName, role, state, linkToRedirect}: RepresentativePersonCardProps) => {
  return (
        ...
        <a>
            <div className={styles.representativePersonCardComponent}>
                ...
                <div className={styles.infoPerson}>
                    ...
                    <span className={styles.personRole}>{role} {state}</span>
                </div>
            </div>
        </a>
      </Link>
